...
const Footer = () => {
    return ( 
        <p className={styles.footer}>
            ...
            <br /> <br />
            At the same time, the user acknowledges and accepts that blockchain technology, DeFi and any other related services are based on high risk, in particular in terms of volatility of prices of virtual currencies, including at the time of transactions or using the information included on this website. In view of the foregoing, by using www.stats.basketcoin.org, <br /> I unconditionally declare that I accept all risks associated with operating in the markets for virtual currencies or cryptocurrencies, and I also declare that BasketCoin has not guaranteed any profits or made any representations to this or similar effect.
        </p>
     );
}
